...
| 9 | Team commitments / civilization (M7) | **PARTIAL — offline checks only** (2026-09-24) | existing social/society flags | `library/society.js`, `library/planner.js`, `roleplay/telemetry.js`, `SOCIAL_CIVILIZATION_DEVELOPMENT.md` | Recipient-need supply commitments have one claimant, a lease, failure/retry state and a donor-observed `playerCollect` receipt; planner and telemetry expose them. Recipient verification, negotiation, multi-step projects and in-game evidence remain open. |
